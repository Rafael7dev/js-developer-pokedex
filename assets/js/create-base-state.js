function createBaseState(pokemon) {
  ...
  baseState.appendChild(createElementAttribute("Ataque", pokemon.attack));
  baseState.appendChild(createElementAttribute("Defesa", pokemon.defense));
  ...
  baseState.appendChild(createElementAttribute("Velocidade", pokemon.speed));
}
